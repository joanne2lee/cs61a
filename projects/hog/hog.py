...
def swine_align(player_score, opponent_score):
    ...
    if player_score and opponent_score != 0:
        d = gcd(player_score, opponent_score)
        if d >= 10:
            turn = True
        else:
            turn = False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 += take_turn(numroll0, score1, dice)
            ...
            score1 += take_turn(numroll1, score0, dice)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        ...
        return announce_highest(who,score,max(score_gain,running_high))
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while num_rolls <= 10:
        turn_score = roll_average(num_rolls, dice)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score+free_bacon(opponent_score),opponent_score) == True:
        roll = 0
    elif free_bacon(opponent_score) >= cutoff and extra_turn(score,opponent_score) == False:
        roll = 0
    else:
        roll = num_rolls
    return roll
